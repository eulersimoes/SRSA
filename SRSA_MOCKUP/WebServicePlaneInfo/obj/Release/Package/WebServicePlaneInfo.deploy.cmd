...
set _DeploySetParametersFile=%RootPath%WebServicePlaneInfo.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%WebServicePlaneInfo.zip" (
echo "%RootPath%WebServicePlaneInfo.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%WebServicePlaneInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%WebServicePlaneInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%WebServicePlaneInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%WebServicePlaneInfo.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%WebServicePlaneInfo.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%WebServicePlaneInfo.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%WebServicePlaneInfo.deploy-readme.txt" (
...
start notepad "%RootPath%WebServicePlaneInfo.deploy-readme.txt"
)
echo =========================================================
goto :eof
